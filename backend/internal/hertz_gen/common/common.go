...
type Response struct {
	...
	Success bool   `thrift:"success,3,required" form:"success,required" json:"success,required" query:"success,required"`
	Data    []byte `thrift:"data,4,optional" form:"data" json:"data,omitempty" query:"data"`
}
