...
func TestExprExample(t *testing.T) {
	type Test struct {
		A  int             `tagexpr:"$<0||$>=100"`
...
func TestNil(t *testing.T) {
	...
	assert.EqualError(t, validator.Validate((*F)(nil)), "unsupport data: nil")
}
...
func TestAll(t *testing.T) {
	...
	assert.EqualError(t, validator.Validate(new(T), true), "email format is incorrect\tinvalid parameter: f.g")
}
...
func TestIssue1(t *testing.T) {
	...
	assert.EqualError(t, validator.Validate(req, false), "email format is incorrect")
}
...
func TestIssue30(t *testing.T) {
	...
	assert.EqualError(t, validator.Validate(&TStruct{TOk: "1"}), "invalid parameter: TOk")
...
func TestIssue31(t *testing.T) {
	...
	assert.EqualError(t, validator.Validate(&TStruct{A: []int32{1}}), "syntax error: \"($ != nil && range($, in(#v, 1, 2, 3))\"")
	assert.EqualError(t, validator.Validate(&TStruct{A: []int32{1}}), "syntax error: \"($ != nil && range($, in(#v, 1, 2, 3))\"")
	assert.EqualError(t, validator.Validate(&TStruct{A: []int32{1}}), "syntax error: \"($ != nil && range($, in(#v, 1, 2, 3))\"")
}
...
func TestRegexp(t *testing.T) {
	...
	assert.NoError(t, validator.Validate(&TStruct{A: "0.0.0.0"}))
	assert.EqualError(t, validator.Validate(&TStruct{A: "0...0"}), "invalid parameter: A")
	assert.EqualError(t, validator.Validate(&TStruct{A: "abc1"}), "invalid parameter: A")
	assert.EqualError(t, validator.Validate(&TStruct{A: "0?0?0?0"}), "invalid parameter: A")
}
