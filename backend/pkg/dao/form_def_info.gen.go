...
func newFormDefInfo(db *gorm.DB, opts ...gen.DOOption) formDefInfo {
	...
	_formDefInfo.ID = field.NewInt64(tableName, "id")
	_formDefInfo.FormDefID = field.NewString(tableName, "form_def_id")
	_formDefInfo.FormDefName = field.NewString(tableName, "form_def_name")
	_formDefInfo.HTMLContent = field.NewString(tableName, "html_content")
	_formDefInfo.HTMLPageURL = field.NewString(tableName, "html_page_url")
	_formDefInfo.Status = field.NewInt32(tableName, "status")
	_formDefInfo.Remark = field.NewString(tableName, "remark")
